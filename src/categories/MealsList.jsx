      ...
      {!recipe.idMeal ? <Loader /> : (
        ...
        >
          ...
          <CardBody>
            ...
            <Button onClick={handlerShow} color='primary' className="my-3" >Show Recipe</Button>
            {showrecipe ? (
              <Table>
                <thead>
                  <tr>
            ...
            <h4>Watch video</h4>
            {recipe.strYoutube ? <iframe style={{width: '100%', height: '300px'}} src={`https://www.youtube.com/embed/${recipe.strYoutube.slice(- 11)}`} title={id} /> : null}
          </CardBody>
        </Card>
      )}
    </div>
